...
\begin{titlepage}
  ...
  \begin{quote}
    ...
    \noindent \textbf{Acknowledgments:} We would like to express our gratitude to Michael Halling for valuable input and guidance, and Alexios Ghalanos for invaluable work on the \texttt{rugarch} R package.
  \end{quote}
