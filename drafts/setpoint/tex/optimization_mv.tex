...
\begin{figure}[htbp]
  \ContinuedFloat
  \centering
  \includegraphics[scale=1]{graphics/weights/main_Weights_MV_5F_EXCL_RMW_5F.png}
  \footnotesize
...
\begin{figure}[htbp]
  \ContinuedFloat
  \centering
  \includegraphics[scale=1]{graphics/weights/main_Weights_MV_6F_EXCL_RMW_6F.png}
  \footnotesize
