...
\input{tex/model/choosing} % motivating the choice of copula, and among copulas

\input{tex/model/copula} % the boom

\input{tex/model/univariate} % arma garch

\input{tex/model/dependence} % threshold and rolling

\input{tex/model/results} % estimation results and explaining parameterization choice
