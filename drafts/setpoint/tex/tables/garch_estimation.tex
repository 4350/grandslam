...
\begin{table}
  ...
  \begin{longcaption}
    Models from~\autoref{eq:garch_mean} and~\autoref{eq:garch_garch} on $N = 2,766$ weekly returns 1963--2016, with skewed Student's \emph{t} innovations. Robust standard errors in parentheses, following~\textcite{White1982}. $\omega$ is set using variance targeting, following~\textcite{EngleMezrich1995}. Ljung-Box and ARCH-LM tests are the weighted portmanteau tests from \textcite{FisherGallagher2012} and the sign bias test is from \textcite{EngleNg1993} (see~\autoref{app:univariate_diagnostics}). Significance given by $^{*}p<10\%$; $^{**}p<5\%$; $^{***}p<1\%$
  \end{longcaption}
  ...
  \begin{tabularx}{\textwidth}{@{}l X dddddd}
    ...
    LLH  &&
      \multicolumn{1}{D{.}{.}{3}}{7,051} &
      \multicolumn{1}{D{.}{.}{3}}{8,567} &
      \multicolumn{1}{D{.}{.}{3}}{7,941} &
      \multicolumn{1}{D{.}{.}{3}}{8,788} &
      \multicolumn{1}{D{.}{.}{3}}{9,574} &
      \multicolumn{1}{D{.}{.}{3}}{9,872} \\
