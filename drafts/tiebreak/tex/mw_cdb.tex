...
We begin by describing the construction and intuition of CDB and subsequently present the results of two analyses using CDB: First, we use simulated distributions of portfolio returns from our Student's \textit{t} dynamic copula model to discuss the relative diversification benefits of HML, CMA and RMW. Second, we compare the diversification benefits of out-of-sample investing according to one of three strategies: (1) equal weights, (2) mean-variance weights and (3) maximum-CDB weights.
