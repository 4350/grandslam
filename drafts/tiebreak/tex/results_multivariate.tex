...
\subsubsection{Copula with constant correlations}
\label{subsubsec:constant_copula}
% diagnostics of fit
% theory
...
\subsubsection{Copula results with dynamic correlations}
\label{subsubsec:dynamic_copula}
